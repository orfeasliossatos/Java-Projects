...
public abstract class Player extends MovableAreaEntity implements Interactor {
    ...
    public void enterArea(Area area, DiscreteCoordinates position) {
        ...
        switch(area.getTitle()) {
			case "zelda/RouteTemple" : 	{area.setViewCandidate(null); break;}
			case "zelda/Temple" :		{area.setViewCandidate(null); break;}
			default : 					{area.setViewCandidate(this); break;}
        }
